 ...
 * @author javier.tambo
 */
public class CerrarEvento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CerrarEvento</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CerrarEvento at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             evento=servEventos.consultaEventoId(Long.parseLong(id_evento));
             evento.setEstado_evento("CERR");
        Long id_nuevo_evento = servEventos.registroEvento(evento);
