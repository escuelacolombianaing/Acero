...
public class RegistroEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RegistroEstudiante</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RegistroEstudiante at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Usuario nuevo_usuario = new Usuario( id_usu, id_nacional, nombre, apellido, correo_electronico, password_retos, "ESIN", new Long(-1), tipo_id, telefono, "APRO");
        String destino = "";
        Long id_definitivo;
        try {
