...
public class DescargarArchivo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //FileInputStream archivo = new FileInputStream("C:\\Sun\\AppServer\\config\\Acero\\Entregables\\"+id_reto+"\\"+id_equipo+"\\"+nombre); 
        FileInputStream archivo = new FileInputStream("/usr/local/SUN/2/glassfish/domains/domain1/docroot/Acero/Entregables/" + id_reto + "/" + id_equipo + "/" + nombre);
