    ...
    <section class="registro">
        ...
        <div class="container fondo-background">
            <form accept-charset="ISO-8859-1" action="RegistroReto" method="post" class="espaciado">
                ...
                <div class="col-sm-6 col-md-6">
                    <input  style="width: 300px;" type="submit" onclick="document.getElementById('estado').value = 'ENRE'" class="btn btn-primary center-block" role="button" value="Guardar Cambios y Enviar a Revisión">
                </div>
                <div class="col-sm-6 col-md-6">
