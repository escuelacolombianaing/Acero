<%-- 
    Document   : PantallaPanelControlEmpresa
...
<%
    ServiciosEmpresas servEmpresa = new ServiciosEmpresasJDBC();
    Empresa empRepresentada = servEmpresa.consultaEmpresaRepresentante(usuario);
    if(empRepresentada==null){
        response.sendRedirect("LogOut?respuesta=5");
    }
    ...
    <section class="registro">
        ...
        <div class="container fondo-background">
            <form accept-charset="ISO-8859-1" action="RegistroEmpresa" method="post" class="espaciado">
                <div class="col-sm-12 col-md-12 col-lg-12"><h3>Panel de Control Empresa<hr></h3></div>
                <div class="row">
