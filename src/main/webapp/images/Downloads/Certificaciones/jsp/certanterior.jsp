...
//Se verifica si el progrma tiene acreditación de alta calidad
    ...
    if (inf.elementAt(8).toString().equals("No disponible")){
       ...
       acred = " y acreditación de Alta Calidad " + inf.elementAt(8).toString() ;
    } else
              ...
              <table width="80%" border="0" align="center">
                ...
                <tr> 
                  <td> 				  
                    <p> 
                      <center>
                        <textarea name="texto2" cols="110" rows="5">Que <%=senor%> <%=inf.elementAt(0)%>, <%=ident%> con <%=doc%> <%=cadena%>, estudiante del programa de <%=inf.elementAt(2)%>, formalizó su última matrícula en el <%=periodo%> de <%=a%>. Jornada Diurna de 7:00 a.m. a 7:00 p.m.
          				 </textarea>
                      </center>
                    </p>					
                  </td>
