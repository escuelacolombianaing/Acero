<%-- 
    Document   : PantallaPanelControlAdministrador
...
<body>
    ...
    <section class="registro">
        ...
        <div class="container fondo-background">
            <div class="col-sm-12 col-md-12 col-lg-12"><h3>Panel de Control Administrador<hr></h3></div>
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                        <a href="PantallaConsultaEventosAdministrador">
                            <button class="btn btn-primary center-block" style="width: 200px;" type="button" class="form-control">Consultar Eventos</button>
                        </a>
                    </div>
                    <div class="form-group">
                        <a href="PantallaConsultaRetoAdministrador">
                            <button class="btn btn-primary center-block" style="width: 200px;" type="button" class="form-control">Consultar Retos</button>
                        </a>
                    </div>
                    <div class="form-group">
                        <form accept-charset="ISO-8859-1" action="PantallaInformesEventosAdministrador">
                            <label for="id_evento">Seleccione el evento para consultar informe general:</label>
                            <select class="form-control" id="id_evento" name="id_evento" required="">
                                <option value="" selected>Seleccione</option>
                                <%
                                    for (Evento evento : eventos) {
                                        %><option value="<%=evento.getId_evento()%>"><%=evento.getYear()+"-"+evento.getPeriodo()%></option><%
                                    }
                                %>
                            </select>
                            <br>
                            <button class="btn btn-primary center-block" style="width: 300px;" class="form-control">Consultar Informe General</button>
                        </form>
                    </div>
                </div>
            </div>
