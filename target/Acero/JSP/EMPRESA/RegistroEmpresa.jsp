...
<script lang="javascript">
    function validarCamposFormulario(){
        ...
        if(nit.localeCompare(conf_nit)!==0){
            alert("El campo nit no concuerda con el campo de confirmación del nit.");
            return false;
        }
        ...
        if(email_contacto.localeCompare(conf_email_contacto)!==0){
            alert("El campo email no concuerda con el campo de confirmación del email.")
            return false;
        }
        ...
        if(password.localeCompare(conf_password)!==0){
            alert("El campo contraseña no concuerda con el campo de confirmación del contraseña.")
            return false;
        }
        ...
        <div class="container fondo-background">
            <form accept-charset="ISO-8859-1" action="Empresa" method="post" onsubmit="return validarCamposFormulario()" class="espaciado">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nit" placeholder="Solamente números, con dígito de verificación y sin (-)" id="nit" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="conf_nit">Confirmación de Nit (XXXXXXXXXXXX):</label>
                            <input type="number" class="form-control" name="conf_nit" placeholder="Solamente números, con dígito de verificación y sin (-)" id="conf_nit" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="direccion_empresa" placeholder="Dirección de la Empresa" id="direccion_empresa" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="pagina_web">Página Web de la Empresa:</label>
                            <input type="url" class="form-control" name="pagina_web" placeholder="Página Web de la Empresa" id="pagina_web" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="telefono_empresa">Teléfono:</label>
                            <input type="tel" minlength="7" class="form-control" name="telefono_empresa" placeholder="Teléfono" id="telefono_empresa" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="descripcion_empresa">Actividad Económica:</label>
                            <textarea type="text" class="form-control" name="descripcion_empresa" placeholder="Descripción de la Empresa" id="descripcion_empresa" required=""></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="id_contacto">Número de Identificación:</label>
                            <input type="number" class="form-control" name="id_contacto" placeholder="Identificación del Contacto" id="id_contacto" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="">Teléfono de Contacto:</label>
                            <input type="tel" minlength="7" class="form-control" name="tel_contacto" placeholder="Teléfono de Contacto" id="tel_contacto" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="conf_email_contacto">Confirmar Correo Electrónico de Contacto:</label>
