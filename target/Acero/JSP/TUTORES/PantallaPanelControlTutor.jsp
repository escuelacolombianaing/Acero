...
<body>
    ...
    <section class="registro">
        ...
        <div class="container fondo-background">
                <div class="col-sm-12 col-md-12 col-lg-12"><h3>Panel de Control Tutor</h3></div>
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <a href="PantallaConsultaAsignacionEquipos">
                                <button class="btn btn-primary center-block" style="width: 250px;" type="button" class="form-control">Consulta Equipos Asignados</button>
                            </a>
                        </div>
                    </div>
                </div>
