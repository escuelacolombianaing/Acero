...
<body>
    ...
    <section class="registro">
        <div class="container fondo-background">
            <form accept-charset="ISO-8859-1" action="RegistroTutor" method="post" onsubmit="return validarCamposFormulario()" class="espaciado">
                <div class="col-sm-12 col-md-12 col-lg-12"><h3>Registro Tutores<hr></h3></div>
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre del Tutor" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="apellido">Apellido:</label>
                            <input type="text" class="form-control" name="apellido" id="apellido" placeholder="Apellido del Tutor" required="">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
