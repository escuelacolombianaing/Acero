<%-- 
    Document   : PantallaPostulaEquipoRetoEstudiante
    Created on : 19-dic-2019, 15:15:01
    Author     : andres.rojas
--%>
...
<%
    ...
    Equipo equipo = servEquipos.consultarEquipoId(usuario.getId_equipo());
    ...
    List<Reto> retos_desarrolla = equipo.getRetos_desarrolla();
    Boolean postulado = false;
    for (Reto reto : retos_desarrolla) {
        if(reto.getId_reto().equals(reto_actual.getId_reto())){
            postulado=true;
        }
    }
    String estado_reto = "";
            ...
            <div class="col-sm-12 col-md-12 col-lg-12"><h3>Reto <%=reto_actual.getId_reto()+"-"+evento_actual.getYear()+"-"+evento_actual.getPeriodo()%><hr></h3></div>
	            ...
	            <div class="row">
	            	...
	            	<div class="col-sm-12 col-md-10">
                            <form accept-charset="ISO-8859-1" action="PostulaEquipoReto" method="post">
                                <table class="table fondoColorTotal">
                                    <thead class="thead-color">
                                        <tr>
                                            ...
                                            <th class="capital">EQUIPO POSTULADO</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <tr>
                                          ...
                                          <td scope="row"><b><%=(postulado)?"SI":"NO"%></b></td>
                                      </tr>
                                    </tbody>
                                </table>
                                <input type="hidden" name="id_reto" id="id_reto" value="<%=reto_actual.getId_reto()%>">
                                <%if(!postulado){%>
                                <label for="postular">
                                    Postular mi equipo a este reto:
                                </label>
                                <input class="btn btn-primary center-block" type="submit" name="postular" id="postular" value="Postular">
                                <%}%>
                            </form>
	            	</div>
	            	<div class="col-md-1"></div>
